...
(function initAboutSec(){
    ...
    creEl('div', ['aboutParagraph', 'sectionParagraph'], 'aboutIntroText', 0, "I'm an experienced Front End web developer. I have spent years perfecting my skills in JavaScript and CSS. I did a degree in multimedia which dealt with topics such as web design, programming and graphic design. Since then I have spent my time creating numerous complex projects in JavaScript. ")

...
let nocontextData = {name: 'NC-Creepy'};

//List of elements to be created using createEl function
let elementsData = [
    {type: 'div', className: ['creepApp'], append: '.main'},
    {type: 'div', className: ['optionsSec'], append: '.creepApp'},
    ...
    {type: 'div', className: ['titleSec'], append: '.creepApp'},
    ...
    {type: 'div', className: ['searchSec'], append: '.creepApp'},
    ...
    {type: 'div', className: ['creepMain'], append: '.creepApp'},
    {type: 'div', className: ['mainText'], append: '.creepMain'},
    {type: 'div', className: ['footerSec'], append: '.creepApp'},
...
(function initApp(){
    underlineLink(nocontextData.name);
    createInputs();
